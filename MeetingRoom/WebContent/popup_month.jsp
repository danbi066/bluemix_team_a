...
<body>
	...
	<form name="frm" method="post" onsubmit="return closeMe(this);">
		...
		<img class="img-responsive2" src="image/colorbar-01.png" title="top"> <br>
		<br>
		<div class="fontSize">
			<center>
				<table class="col-md-9 col-sm-8 col-xs-12" style="font-family: 'Jeju Gothic', serif !important; font-size: 80%; padding-top: 5%; margin-left: 3%" align="center">
					<tr>
						<td>반복주기 :</td>
						<td>매월</td>
					</tr>
					...
					<tr>
						...
						<td><input type="text" name="start_dt" id="start_dt" readonly style="width: 50%; font-size: 80%;" onfocus="getWeekday(this.value);"></td>
					</tr>
					<tr>
						<td>종료날짜 :</td>
						<td><input type="text" name="end_dt" id="end_dt" style="width: 50%; font-size: 80%;"><br> <script>
							$('#end_dt').datepicker({
								dateFormat : 'yy-mm-dd'
			...
			<center>
				<input type="submit" value="설정" style="font-size: 70%;">&nbsp;&nbsp;&nbsp; <input type="reset" value="취소" style="font-size: 70%;" onClick="window.close();">
			</center>
		</div>
