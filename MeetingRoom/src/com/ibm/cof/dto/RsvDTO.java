...
public class RsvDTO {
	...
	private String Rsv_Approved;
	private int Rsv_Repeat_Seq;

	public RsvDTO() {
	};

	public RsvDTO(String title, String site, String confer_nm, String date, String start, String end, String name, String phone) {
		Rsv_Title = title;
		Rsv_Site = site;
	...
	public RsvDTO(int seq, String date, String start_time, String end_time, String title, String site, String confer_nm, String name, String phone, String email, String del_pw, String color, int repeat_seq) {
		Rsv_Seq = seq;
		Rsv_Date = date;
	...
	public RsvDTO(int seq, String date, String start_time, String end_time, String title, String site, String confer_nm, String name, String phone, String email, String del_pw, String color) {
		Rsv_Seq = seq;
		Rsv_Date = date;
		Rsv_Start_Time = start_time;
		Rsv_End_Time = end_time;
	...
	public RsvDTO(String rsv_Date, String rsv_Start_Time, String rsv_End_Time, String rsv_Title, String rsv_Site, String rsv_Confer_Nm, String rsv_Mem_Nm, String rsv_Mem_Pn, String rsv_Mem_Em, String rsv_Del_Pw, String color, String rsv_approved) {
		Rsv_Date = rsv_Date;
		...
		Rsv_Color = color;
		Rsv_Approved = rsv_approved;
	}

	public RsvDTO(String rsv_Start_Time, String rsv_End_Time, String rsv_Title, String rsv_Site, String rsv_Confer_Nm, String rsv_Mem_Nm, String rsv_Mem_Pn, String rsv_Mem_Em, String rsv_Del_Pw, String rsv_Color) {
		// Rsv_Date = rsv_Date;
	...
	public RsvDTO(int seq, String title, String site, String confer_nm, String date, String email, String start_time, String end_time, String name, String phone) {
		Rsv_Seq = seq;
		Rsv_Date = date;
		Rsv_Start_Time = start_time;
		Rsv_End_Time = end_time;
	...
	public RsvDTO(Integer seq, String date, String start_time, String end_time, String title, String site, String confer_nm, String name, String phone, String email, String del_pw, String color, String rsv_approved) {
		Rsv_Seq = seq;
		Rsv_Date = date;
		Rsv_Start_Time = start_time;
		Rsv_End_Time = end_time;
	...
	public String getRsv_Approved() {
		return Rsv_Approved;
	}

	public void setRsv_Approved(String rsv_approved) {
		Rsv_Approved = rsv_approved;
	}
}
